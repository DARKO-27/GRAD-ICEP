 ...
 * @author kgaog
 */
public class RemoveJobByCompanyNameSessionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cfl.removeJobByName(jobName);
        
        RequestDispatcher rd =request.getRequestDispatcher("company-removed-job-by-name.jsp");
